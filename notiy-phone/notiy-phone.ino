...
int64_t test_val = 0xAABBCCDD11223344;
...
void setup() {
  ...
  BLEDevice::init("ESP32 - Server (slave)");
  ...
  descriptor_2902 = new BLE2902();
  descriptor_2902->setNotifications(true); // true
...
void loop() {
  ...
  if (deviceConnected) {
    ...
    test_val = esp_timer_get_time();
    pCharacteristic->setValue((uint8_t *)&test_val, 8);
